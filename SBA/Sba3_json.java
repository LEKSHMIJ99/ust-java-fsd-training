...
public class Sba3_json {

	public static void main(String[] args) throws Exception{
		// TODO Auto-generated method stub	
		//XSSFWorkbook web = new XSSFWorkbook();
		//FileOuputStream foe = new FileOutputStream(new File("C:\\Users\\ustjavafsdb209\\Downloads\\Data.xls"));\\
		
		JSONParser p = new JSONParser();
		HSSFWorkbook wb = new HSSFWorkbook();
		HSSFSheet st = wb.createSheet();
		OutputStream fo = new FileOutputStream(new File("C:\\Users\\ustjavafsdb217\\Downloads\\EmployeeData.xls"));
		...
		try {
			JSONArray o = (JSONArray)p.parse(new FileReader("C:\\Users\\ustjavafsdb217\\Downloads\\EmployeeData.json"));
